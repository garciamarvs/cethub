...
<body class="top-navigation">
	<div id="wrapper" class="fixed-nav">
		<div id="page-wrapper" class="gray-bg chat-div">
						...
						<div class="col-lg-12">
							<div class="chat-message-form">
								<div class="form-group">
									<div class="col-md-11 col-xs-9" style="padding: 0 !important;">
										<textarea id="msg" class="form-control message-input pull-left" name="message" placeholder="Enter message text"></textarea>
									</div>
									<div class="col-md-1 col-xs-3" style="padding: 0 !important;">
										<button class="btn btn-primary pull-right" style="width:100%; height:90px !important;" type="button" id="send"><h1>&crarr;</h1></button>
									</div>
								</div>
							</div>
						</div>
